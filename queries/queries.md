...
## Unreachable code
- [Description](https://codeql.github.com/codeql-query-help/python/py-unreachable-statement/)
- [Query](https://github.com/github/codeql/blob/main/python/ql/src/Statements/UnreachableCode.ql)


## Unused import
- [Description](https://codeql.github.com/codeql-query-help/python/py-unused-import/)
- [Query](https://github.com/github/codeql/blob/main/python/ql/src/Imports/UnusedImport.ql)


## `__eq__` not overridden when adding attributes
- [Description](https://codeql.github.com/codeql-query-help/python/py-missing-equals/)
- [Query](https://github.com/github/codeql/blob/main/python/ql/src/Classes/DefineEqualsWhenAddingAttributes.ql)

## Module is imported more than once
- [Description](https://codeql.github.com/codeql-query-help/python/py-repeated-import/)
